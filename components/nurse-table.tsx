...
export default function NurseTable({ data }: NurseTableProps) {
  ...
  const handleUpdateSubmit = () => {
    console.log('Update nurse', formData)
    // TODO: Implement API call to update nurse
  ...
  const handleDeleteConfirm = () => {
    console.log('Delete nurse', selectedRow)
    // TODO: Implement API call to delete nurse
  ...
  const handleInsertSubmit = () => {
    console.log('Insert nurse', insertFormData)
    // TODO: Implement API call to insert nurse
